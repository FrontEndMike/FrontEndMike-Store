...
const Hero = ({ }) => {
    return(
        <div className="hero relative h-screen w-full flex items-center justify-start text-left bg-cover bg-center" >
        <div className="absolute top-0 right-0 bottom-0 left-0 bg-gray-900 opacity-75"></div>
        
            <div className="px-10 lg:px-24 z-2">
                <div className="text-left">
                <h2 className="text-4xl tracking-tight leading-10 font-extrabold sm:text-5xl text-white sm:leading-none md:text-6xl">
                    Enter Your 
                    <span className="text-tangerine"> Headline</span>
                </h2>

          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div className="sm:col-span-1 text-center col-span-2 rounded-lg">
              <a href={product.image} target="_blank">
                <img
                  className="max-h-[300px] rounded mx-auto"
                  src={product.image}
                  alt={product.title}
                />
              </a>
              <p className="mt-2 italic text-redish font-semibold">
            ...
            <div className="sm:col-span-2 col-span-3">
              ...
              <button
                className="mt-4 cursor-pointer min-w-[10rem] p-4 text-center button bg-primary text-white rounded hover:brightness-90 transition duration-300"
